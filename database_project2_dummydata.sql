...
-- product 상품
INSERT INTO product(categoryId, price, title, DESCRIPTION, content, thumbnail) VALUES("B", 14500, "수학리더 개념 1-1 (2024)", "수학리더 시리즈 연산, 개념, 기본, 기본+응용, 응용·심화 중에서 교과서 개념을 익히는 가장 쉬운 단계의 첫단계 개념서이다.", "개념을 이해하는 쉽게 기초력, 이해력 문제들과 연산드릴 문제도 함께 수록하여 방학 때 다음 학기 내용을 미리 학습하기 좋은 선행 교재이다.", "초등교과서_수학리더 개념 1-1 (2024)");
